...
var HDWallet = /** @class */ (function () {
    ...
    HDWallet.init = function (seed, config, coinTypes) {
        return __awaiter(this, void 0, void 0, function () {
            var wallet, txParamsData, transferParams, treeParamsData, treeParams, promises;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wallet = new HDWallet();
                        return [4 /*yield*/, fetch(config.transferParamsUrl)];
                    case 1: return [4 /*yield*/, (_a.sent()).arrayBuffer()];
                    case 2:
                        txParamsData = _a.sent();
                        transferParams = Params.fromBinary(new Uint8Array(txParamsData));
                        return [4 /*yield*/, fetch(config.treeParamsUrl)];
                    case 3: return [4 /*yield*/, (_a.sent()).arrayBuffer()];
                    case 4:
                        treeParamsData = _a.sent();
                        ...
                        promises = coinTypes.map(function (coin) { return wallet.enableCoin(coin); });
