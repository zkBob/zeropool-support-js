...
class HDWallet {
    ...
    async enableCoin(coinType, config) {
        ...
        switch (coinType) {
            ...
            case coin_type_1.CoinType.xdai:
            case coin_type_1.CoinType.aurora: {
                const sk = (0, utils_1.deriveSpendingKey)(this.seed, coinType);
                const state = await state_1.ZeroPoolState.create(sk, coinType, BigInt(1000000000));
