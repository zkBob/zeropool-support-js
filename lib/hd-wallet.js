    ...
    async enableCoin(coinType, config) {
        ...
        switch (coinType) {
            case coin_type_1.CoinType.near: {
                coin = new near_1.NearCoin(this.seed, config, this.worker);
                break;
            }
            case coin_type_1.CoinType.ethereum: {
                ...
                coin = new ethereum_1.EthereumCoin(this.seed, web3, config, backend, this.worker);
                break;
            }
            case coin_type_1.CoinType.waves: {
                coin = new waves_1.WavesCoin(this.seed, config, this.worker);
                break;
            }
            default: {
