...
var HDWallet = /** @class */ (function () {
    function HDWallet(seed, config, coins) {
        ...
        for (var _i = 0, coins_1 = coins; _i < coins_1.length; _i++) {
            var value = coins_1[_i];
            var coin = Number(value);
    ...
    HDWallet.prototype.getBalances = function (account) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        promises = Object.keys(this.coins).map(function (coinTypeStr) {
                            var coinType = parseInt(coinTypeStr);
                            var coin = _this.getCoin(coinType);
                            return coin.getBalance(account)
                                .then(function (balance) { return [coinType, balance]; })
                                .catch(function (err) { return [coinType, err]; });
                        });
