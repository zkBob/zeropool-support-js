...
var NearCoin = /** @class */ (function (_super) {
    ...
    function NearCoin(mnemonic, config) {
        ...
        _this.keyStore = new InMemoryKeyStore();
        _this.config = config;
        _this.accounts = new AccountCache();
        _this.rpc = new JsonRpcProvider(_this.config.nodeUrl);
        return _this;
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        account = _a.sent();
                        return [4 /*yield*/, account.account.sendMoney(to, new BN(amount))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.rpc.gasPrice(latestBlock)];
                    case 3:
                        res = _a.sent();
                        gasPrice = new BN(res.gas_price);
                        gas = new BN('30000000000000');
                        fee = gas.mul(gasPrice).toString();
                        feeFormatted = formatNearAmount(fee);
                        return [2 /*return*/, {
                                gas: gas.toString(),
