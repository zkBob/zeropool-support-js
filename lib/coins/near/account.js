...
var AccountCache = /** @class */ (function () {
    ...
    AccountCache.prototype.getOrCreate = function (mnemonic, account) {
        ...
        var path = CoinType.derivationPath(CoinType.near, account);
        ...
        var privateKey = bs58.encode(Buffer.from(naclKeypair.secretKey));
        var keypair = KeyPairEd25519.fromString(privateKey);
