...
var libzeropool_wasm_1 = require("libzeropool-wasm");
...
var Coin = /** @class */ (function () {
    ...
    Coin.prototype.generatePrivateAddress = function (account) {
        var path = coin_type_1.CoinType.privateDerivationPath(this.getCoinType(), account);
        var pair = utils_1.deriveEd25519(path, this.mnemonic, account);
        return libzeropool_wasm_1.deriveAddress(pair.publicKey);
    };
    /**
