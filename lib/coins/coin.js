...
var Coin = /** @class */ (function () {
    ...
    Coin.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sk, coinName, userId, state, acc;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sk = this.getPrivateSpendingKey();
                        coinName = this.getCoinType();
                        userId = bufToHex(hash(sk));
                        return [4 /*yield*/, UserState.init("zp." + coinName + "." + userId)];
                    case 1:
                        state = _a.sent();
                        try {
                            acc = new UserAccount(sk, state);
    ...
    Coin.prototype.generatePrivateAddress = function () {
        return this.privateAccount.generateAddress();
    };
    Coin.prototype.getPrivateSpendingKey = function () {
        var path = CoinType.privateDerivationPath(this.getCoinType());
        var pair = deriveEd25519(path, this.mnemonic); // FIXME: Derive on BabyJubJub
    ...
    Coin.prototype.transferPublicToPrivate = function (account, outputs) {
        throw new Error('unimplemented');
    };
    Coin.prototype.transferPrivateToPrivate = function (account, outputs) {
        throw new Error('unimplemented');
    };
    Coin.prototype.depositPrivate = function (account, amount) {
        throw new Error('unimplemented');
    };
    Coin.prototype.mergePrivate = function () {
        throw new Error('unimplemented');
    };
    Coin.prototype.withdrawPrivate = function (account, amount) {
        throw new Error('unimplemented');
    };
    /**
     * Get current total private balance (account + unspent notes).
     */
    Coin.prototype.getPrivateBalance = function () {
        throw new Error('unimplemented');
    };
    Coin.prototype.updatePrivateState = function () {
        throw new Error('unimplemented');
    };
    Coin.prototype.getNotes = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new Error('unimplemented');
            });
