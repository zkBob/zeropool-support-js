...
var Coin = /** @class */ (function () {
    ...
    Coin.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sk = this.getPrivateSecretKey();
                        coinName = this.getCoinType();
                        return [4 /*yield*/, State.init(coinName + ".unique_user_id_here")];
                    case 1:
                        state = _a.sent();
                        try {
    ...
    Coin.prototype.getPrivateSecretKey = function () {
    ...
    Coin.prototype.transferPrivate = function (account, to, amount) {
        // 1. Deposit
        // 2. Transfer
