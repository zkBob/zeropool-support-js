...
var EthPrivateTransaction = /** @class */ (function () {
    ...
    EthPrivateTransaction.fromData = function (txData, txType, acc, params, web3) {
        var tx = new EthPrivateTransaction();
        // FIXME: nextTreeIndex == 0
        var nextIndex = acc.nextTreeIndex();
        ...
        var txProof = Proof.tx(params, txData.public, txData.secret);
    ...
    EthPrivateTransaction.decode = function (data) {
        ...
        var memoSize = reader.readNumber(1);
