...
var EthereumCoin = /** @class */ (function (_super) {
    ...
    function EthereumCoin(mnemonic, config, transferParams, treeParams) {
        ...
        _this.tokenContract = new _this.web3.eth.Contract(tokenAbi, config.tokenContractAddress);
        return _this;
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!(privateBalance < totalOut)) return [3 /*break*/, 4];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.signAndSendPrivateTx(account, TxType.Transfer, outs, memo)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        memo = new Uint8Array(8);
                        return [4 /*yield*/, this.approveAllowance(account, amount)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.signAndSendPrivateTx(account, TxType.Deposit, amount, memo)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    EthereumCoin.prototype.approveAllowance = function (account, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var address, encodedTx, txObject, gas, gasPrice, _a, nonce, signedTx, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        address = this.getAddress(account);
                        encodedTx = this.tokenContract.methods.approve(this.config.contractAddress, BigInt(amount)).encodeABI();
                        txObject = {
                            from: address,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        addressBin = hexToBuf(address);
                        memo.set(addressBin, 8);
                        return [4 /*yield*/, this.signAndSendPrivateTx(account, TxType.Withdraw, amount, memo)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    EthereumCoin.prototype.signAndSendPrivateTx = function (account, txType, out, memo) {
        return __awaiter(this, void 0, void 0, function () {
            var DENOMINATOR, address, privateKey, txData, tx, data, txObject, nullifier, sign, signature, gas, gasPrice, _a, nonce, signed, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (typeof out === 'string') {
                            ...
                            out = out.map(function (_a) {
                                var to = _a.to, amount = _a.amount;
                                return ({
                                    to: to,
                        ...
                        return [4 /*yield*/, this.privateAccount.createTx(txTypeToString(txType), out, memo)];
                    case 1:
                        txData = _b.sent();
                        tx = EthPrivateTransaction.fromData(txData, txType, this.privateAccount, this.transferParams, this.treeParams, this.web3);
                        data = tx.encode();
                        txObject = {
                            from: address,
                        ...
                        if (!(txType === TxType.Deposit)) return [3 /*break*/, 3];
                        nullifier = '0x' + BigInt(txData.public.nullifier).toString(16).padStart(64, '0');
                        return [4 /*yield*/, this.web3.eth.accounts.sign(nullifier, privateKey)];
                    case 2:
                        sign = _b.sent();
                        signature = toCompactSignature(sign.signature).slice(2);
                        txObject.data += signature;
                        _b.label = 3;
                    case 3: return [4 /*yield*/, this.web3.eth.estimateGas(txObject)];
                    case 4:
                        gas = _b.sent();
                        _a = BigInt;
                        return [4 /*yield*/, this.web3.eth.getGasPrice()];
                    ...
                    case 6:
                        ...
                        txObject.gasPrice = "0x" + gasPrice.toString(16);
                        txObject.nonce = nonce;
                        return [4 /*yield*/, this.web3.eth.accounts.signTransaction(txObject, privateKey)];
                    case 7:
                        signed = _b.sent();
                        return [4 /*yield*/, this.web3.eth.sendSignedTransaction(signed.rawTransaction)];
                    case 8:
