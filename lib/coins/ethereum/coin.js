...
var EthereumCoin = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5: 
                    // Transfer
                    return [4 /*yield*/, this.trasnferPrivateToPrivate(account, outputs)];
                    case 6:
                        // Transfer
                        _b.sent();
                        return [2 /*return*/];
    ...
    EthereumCoin.prototype.trasnferPrivateToPrivate = function (account, outs) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        txData = _a.sent();
                        tx = EthPrivateTransaction.fromData(txData, TxType.Transfer, this.privateAccount, this.params, this.web3).encode();
                        txObject = {
                            from: address,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        txData = _a.sent();
                        tx = EthPrivateTransaction.fromData(txData, TxType.Deposit, this.privateAccount, this.params, this.web3).encode();
                        txObject = {
                            from: address,
                            to: this.config.contractAddress,
                            data: tx,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        txData = _a.sent();
                        tx = EthPrivateTransaction.fromData(txData, TxType.Withdraw, this.privateAccount, this.params, this.web3).encode();
                        txObject = {
                            from: address,
                            to: this.config.contractAddress,
                            data: tx,
    ...
    EthereumCoin.prototype.prepareTranaction = function (txObject, account) {
        return __awaiter(this, void 0, void 0, function () {
