...
export class EthereumCoin extends Coin {
    constructor(mnemonic, web3, config, backend) {
        super(mnemonic);
        this.web3 = web3;
    ...
    updatePrivateState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const curBlockNumber = yield this.web3.eth.getBlockNumber();
            ...
            const logs = yield this.web3.eth.getPastLogs({ fromBlock: latestCheckedBlock + 1, address: this.config.contractAddress });
