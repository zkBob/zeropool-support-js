...
class EthereumCoin extends coin_1.Coin {
    ...
    cachePrivateTx(raw) {
        ...
        if (numItems > utils_2.CONSTANTS.OUT + 1) {
            console.warn(`Invalid transaction: number of outs is greater than ${utils_2.CONSTANTS.OUT + 1} (${numItems})`);
            numItems = utils_2.CONSTANTS.OUT + 1;
        }
