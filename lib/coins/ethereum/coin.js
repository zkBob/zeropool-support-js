...
var EthereumCoin = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.prepareTranaction(txObject, account, txData.public.nullifier)];
                    case 2:
                        signed = _a.sent();
                        return [4 /*yield*/, this.web3.eth.sendSignedTransaction(signed)];
                    case 3:
    ...
    EthereumCoin.prototype.prepareTranaction = function (txObject, account, nullifier) {
        return __awaiter(this, void 0, void 0, function () {
            var address, gas, gasPrice, nonce, privateKey, signed, tx, serialized, hash, sign;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        address = this.getAddress(account);
                    ...
                    case 3:
                        ...
                        if (!nullifier) return [3 /*break*/, 5];
                        tx = TransactionFactory.fromTxData(txObject);
                        serialized = tx.serialize().toString('hex');
                        hash = this.web3.utils.sha3(nullifier.padStart(32, '0'));
                        return [4 /*yield*/, this.web3.eth.sign(address, hash)];
                    case 4:
                        sign = (_a.sent()).slice(2);
                        serialized += sign;
                        signed = serialized;
                        return [3 /*break*/, 8];
                    case 5: return [4 /*yield*/, this.web3.eth.accounts.signTransaction(txObject, privateKey)];
                    case 6: return [4 /*yield*/, (_a.sent()).rawTransaction];
                    case 7:
                        signed = _a.sent();
                        _a.label = 8;
                    case 8: return [2 /*return*/, signed];
                }
            });
        });
    };
