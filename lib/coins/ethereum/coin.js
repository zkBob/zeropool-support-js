...
var EthereumCoin = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        nullifier = BigInt(txData.public.nullifier).toString(16).padStart(64, '0');
                        return [4 /*yield*/, this.prepareTranaction(txObject, account, nullifier)];
                    case 2:
                        signed = _a.sent();
                        return [4 /*yield*/, this.web3.eth.sendSignedTransaction(signed)];
                    case 3:
    ...
    EthereumCoin.prototype.prepareTranaction = function (txObject, account, nullifier) {
        return __awaiter(this, void 0, void 0, function () {
            var address, privateKey, sign, signature, gas, gasPrice, nonce, tx, signed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        address = this.getAddress(account);
