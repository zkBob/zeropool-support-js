...
var EthereumCoin = /** @class */ (function (_super) {
    ...
    function EthereumCoin(mnemonic, config) {
        ...
        _this.contract = new _this.web3.eth.Contract(ABI, config.contractAddress);
        _this.config = config;
        return _this;
    }
    ...
    EthereumCoin.prototype.transferPrivate = function (account, outputs) {
        return __awaiter(this, void 0, void 0, function () {
            var address, newPrivateAddress, totalOut, curBalance, _a, txData, privateBalance;
    ...
    EthereumCoin.prototype.fetchNotes = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sk, events, _i, events_1, event_1, message, data, pair, note;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        for (_i = 0, events_1 = events; _i < events_1.length; _i++) {
                            event_1 = events_1[_i];
                            message = event_1.raw.data;
                            data = bs64.toByteArray(message);
                            try {
                                pair = this.privateAccount.decryptPair(data);
                                if (pair) {
                                    ...
                                    note = this.privateAccount.decryptNotes(data);
