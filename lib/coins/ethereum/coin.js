...
var EthereumCoin = /** @class */ (function (_super) {
    ...
    EthereumCoin.prototype.transferPrivateToPrivate = function (account, outs) {
        return __awaiter(this, void 0, void 0, function () {
            var address, memo, txData, tx, data, txObject, signed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        address = this.getAddress(account);
                    ...
                    case 1:
                        txData = _a.sent();
                        tx = EthPrivateTransaction.fromData(txData, TxType.Transfer, this.privateAccount, this.transferParams, this.treeParams, this.web3);
                        data = tx.encode();
                        txObject = {
                            from: address,
                        ...
                        return [4 /*yield*/, this.prepareTransaction(txObject, tx, account)];
                    case 2:
                        signed = _a.sent();
    ...
    EthereumCoin.prototype.depositPrivate = function (account, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var address, memo, txData, tx, data, txObject, nullifier, signed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        address = this.getAddress(account);
                    ...
                    case 1:
                        txData = _a.sent();
                        tx = EthPrivateTransaction.fromData(txData, TxType.Deposit, this.privateAccount, this.transferParams, this.treeParams, this.web3);
                        data = tx.encode();
                        txObject = {
                            from: address,
                            to: this.config.contractAddress,
                        ...
                        return [4 /*yield*/, this.prepareTransaction(txObject, tx, account, nullifier)];
                    case 2:
                        signed = _a.sent();
                        return [4 /*yield*/, this.web3.eth.sendSignedTransaction(signed)];
                    case 3:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        txData = _a.sent();
                        tx = EthPrivateTransaction.fromData(txData, TxType.Withdraw, this.privateAccount, this.transferParams, this.treeParams, this.web3);
                        data = tx.encode();
                        txObject = {
                            from: address,
                            to: this.config.contractAddress,
    ...
    EthereumCoin.prototype.prepareTransaction = function (txObject, privateTx, account, nullifier) {
        return __awaiter(this, void 0, void 0, function () {
            var address, privateKey, sign, signature, gas, gasPrice, _a, nonce, tx, signedTx, hex;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        address = this.getAddress(account);
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2: return [4 /*yield*/, this.web3.eth.estimateGas(txObject)];
                    case 3:
                        gas = _b.sent();
                        _a = BigInt;
                        return [4 /*yield*/, this.web3.eth.getGasPrice()];
                    case 4:
                        gasPrice = _a.apply(void 0, [_b.sent()]) * BigInt(2);
                    ...
                    case 5:
                        ...
                        tx = TransactionFactory.fromTxData(txObject);
                        signedTx = tx.sign(Buffer.from(privateKey.slice(2), 'hex'));
                        hex = signedTx.serialize().toString('hex');
                        return [2 /*return*/, hex];
                }
            });
        });
