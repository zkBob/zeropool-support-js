...
class RelayerBackend extends backend_1.ZeroPoolBackend {
    ...
    async deposit(privateKey, amountWei, fee = '0') {
        ...
        const txProof = libzeropool_rs_1.Proof.tx(this.snarkParams.transferParams, txData.public, txData.secret);
