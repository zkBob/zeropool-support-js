...
var WavesCoin = /** @class */ (function (_super) {
    ...
    function WavesCoin(mnemonic, config) {
        ...
        _this.config = config;
        _this.api = node_api_js_1.create(config.nodeUrl);
        _this.accounts = new account_1.AccountCache(mnemonic, config.chainId);
        return _this;
    }
    ...
    WavesCoin.prototype.getBalance = function (account) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, waves_transactions_1.nodeInteraction.balance(this.getAddress(account), this.config.nodeUrl)];
                    case 1:
                        balance = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        transferTx = waves_transactions_1.transfer(money, { privateKey: this.getPrivateKey(account) });
                        return [4 /*yield*/, waves_transactions_1.broadcast(transferTx, this.config.nodeUrl)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    WavesCoin.prototype.getCoinType = function () {
        return coin_type_1.CoinType.waves;
    };
    return WavesCoin;
}(coin_1.Coin));
exports.WavesCoin = WavesCoin;
