...
class TronClient extends client_1.Client {
    ...
    async sendTransaction(to, amount, data, selector) {
        ...
        let tx = await this.tronWeb.transactionBuilder.triggerSmartContract(to, selector, { feeLimit: 100000000, rawParameter: this.truncateHexPrefix(data), callValue: Number(amount) }, []);
