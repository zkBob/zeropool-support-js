...
class AccountCache {
    constructor(mnemonic, web3) {
        ...
        const path = network_type_1.NetworkType.chainPath(network_type_1.NetworkType.ethereum);
    ...
    getOrCreate(accountNumber) {
        ...
        const keypair = this.root.derive('m' + network_type_1.NetworkType.accountPath(network_type_1.NetworkType.ethereum, accountNumber));
